...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x06target\x18\x02 \x01(\tR\x06target\"\x9f\x01\n" +
	"\x04User\x12\x1b\n" +
	"\tuser_uuid\x18\x01 \x01(\tR\buserUuid\x12\x14\n" +
	"\x05login\x18\x02 \x01(\tR\x05login\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12N\n" +
	"\x14notification_methods\x18\x04 \x03(\v2\x1b.auth.v1.NotificationMethodR\x13notificationMethods\"\xa9\x01\n" +
	...
	"\rWhoamiRequest\x12!\n" +
	"\fsession_uuid\x18\x01 \x01(\tR\vsessionUuid\"3\n" +
	...
	"\x04user\x18\x01 \x01(\v2\r.auth.v1.UserR\x04user2\xff\x01\n" +
	"\vAuthService\x12?\n" +
	...
	"\aGetUser\x12\x17.auth.v1.GetUserRequest\x1a\x18.auth.v1.GetUserResponseB5Z3github.com/ChopX4/raketka/pkg/proto/auth/v1;auth_v1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*WhoamiRequest)(nil),      // 6: auth.v1.WhoamiRequest
	(*WhoamiResponse)(nil),     // 7: auth.v1.WhoamiResponse
	(*GetUserRequest)(nil),     // 8: auth.v1.GetUserRequest
	(*GetUserResponse)(nil),    // 9: auth.v1.GetUserResponse
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	0, // 0: auth.v1.User.notification_methods:type_name -> auth.v1.NotificationMethod
	0, // 1: auth.v1.RegisterRequest.notification_methods:type_name -> auth.v1.NotificationMethod
	1, // 2: auth.v1.WhoamiResponse.user:type_name -> auth.v1.User
	1, // 3: auth.v1.GetUserResponse.user:type_name -> auth.v1.User
	...
	6, // 6: auth.v1.AuthService.Whoami:input_type -> auth.v1.WhoamiRequest
	8, // 7: auth.v1.AuthService.GetUser:input_type -> auth.v1.GetUserRequest
	...
	7, // 10: auth.v1.AuthService.Whoami:output_type -> auth.v1.WhoamiResponse
	9, // 11: auth.v1.AuthService.GetUser:output_type -> auth.v1.GetUserResponse
