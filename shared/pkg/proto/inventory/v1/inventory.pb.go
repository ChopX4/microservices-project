...
const (
	Category_CATEGORY_UNKNOWN_UNSPECIFIED Category = 0 // Неизвестная категория
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbc\x01\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB?Z=github.com/ChopX4/raketka/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_goTypes = []any{
	...
	(*PartsFilter)(nil),           // 1: inventory.v1.PartsFilter
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	5,  // 7: inventory.v1.GetPartResponse.part:type_name -> inventory.v1.Part
	1,  // 8: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	5,  // 9: inventory.v1.ListPartsResponse.parts:type_name -> inventory.v1.Part
